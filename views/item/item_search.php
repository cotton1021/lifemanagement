...
<body id="item" class="item_list">
				...
				?>
					<tbody>
						<tr>
							...
							<td data-label="決済日：" class="payment<?php if ($item_pay_confirm == 0) {
																										echo ' not_confirm';
	...
	<div class="setting_area">
		...
		<div><a href="./payment_list.php" target="_blank"><span class="icon"><img src="../../assets/img/payment.svg" alt="支払いリスト"><span class="hover">支払いリスト</span></span></a></div>
